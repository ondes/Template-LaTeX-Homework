...
\begin{figure}[h!]
	\centering
	\subfloat[42 x 42 grid solution of the problem]{\includegraphics[width=0.5\textwidth]{./fig/Q5_B_Bode_Gained.eps}\label{fig:Q5_B_Bode_Gained}}
	\hfill
	\subfloat[Filled constant temperature lines of the 42 x 42 grid]{\includegraphics[width=0.5\textwidth]{./fig/Q5_G_step.eps}\label{fig:42}}
